from app.models.expectativas_mensal import ExpectativaMensal

class ExpectativasMensalProcessor:
    def preprocess(self, data):
        ...
        return ExpectativaMensal(Indicador, data_str, DataReferencia, Media, Mediana, 
